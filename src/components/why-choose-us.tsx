...
const features = [
  ...
  {
    icon: <BookCheck className="w-8 h-8 text-red-500" />,
    title: 'Proven Curriculum',
    description: 'We offer a comprehensive and structured curriculum designed for conceptual clarity.',
  },
  {
    icon: <MessageSquareQuote className="w-8 h-8 text-red-500" />,
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <ScrollReveal key={index}>
              <div className="text-center p-6 bg-stone-50 rounded-2xl shadow-md transform hover:scale-110 hover:shadow-xl transition-all duration-300 h-full">
