        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {courses.map((course, index) => (
            <ScrollReveal key={index} className="h-full">
              <Card className="h-full flex flex-col text-center items-center transform hover:-translate-y-2 transition-transform duration-300 shadow-lg hover:shadow-2xl bg-gradient-to-br from-gray-100 to-white text-gray-800 border-none rounded-2xl">
